...
```ts
import { useArrayFilter, ref } from '@vueuse/core'
...
- [Source Code](https://github.com/vueuse/vueuse/blob/main/packages/shared/useArrayFilter/index.ts)
- [Documentation](https://github.com/vueuse/vueuse/blob/main/packages/shared/useArrayFilter/index.md)
