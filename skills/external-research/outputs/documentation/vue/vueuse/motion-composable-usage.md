...
The [Variants Definitions](https://motion.vueuse.org/features/variants) are described in a specific page.
...
Once called, the useMotion composable will return an instance of [Motion Instance](https://motion.vueuse.org/features/motion-instance).
