...
## [Region-level](https://appwrite.io/docs/products/network/caching\#region-level)
...
## [Edge-level](https://appwrite.io/docs/products/network/caching\#edge-level)
...
## [Private caching](https://appwrite.io/docs/products/network/caching\#cdn-caching)
...
## [Caching rules](https://appwrite.io/docs/products/network/caching\#custom-caching)
