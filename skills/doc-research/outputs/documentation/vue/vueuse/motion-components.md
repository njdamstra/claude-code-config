...
- **`preset`**: Motion preset to use (expects camel-case string), see [Presets](https://motion.vueuse.org/features/presets).
...
Additional variant properties can be explored on the [Variants](https://motion.vueuse.org/features/variants) page.
