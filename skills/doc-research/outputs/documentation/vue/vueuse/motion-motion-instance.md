...
Motion instance is the object exposed when binding to a target element using [v-motion](https://motion.vueuse.org/features/directive-usage) or [useMotion](https://motion.vueuse.org/features/composable-usage).
...
Apply accepts both a [Variant Declaration](https://motion.vueuse.org/features/variants) or a key from the motion instance variants.
...
Calling it with an array of [Motion Properties](https://motion.vueuse.org/features/motion-properties) keys will stop every specified key.
