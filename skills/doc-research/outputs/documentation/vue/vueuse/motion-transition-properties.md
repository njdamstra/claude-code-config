...
They are one of the two parts that compose a [Variant](https://motion.vueuse.org/features/variants), with [Motion Properties](https://motion.vueuse.org/features/motion-properties).
