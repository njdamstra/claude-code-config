...
They are one of the two parts that compose a [Variant](https://motion.vueuse.org/features/variants), with [Transitions Declaration](https://motion.vueuse.org/features/transition-properties).
...
Some keys are **forbidden** ( `transition`, `rotate`, `scale`...) as they are now reserved for [Transform Properties](https://motion.vueuse.org/features/motion-properties#transform-properties).
