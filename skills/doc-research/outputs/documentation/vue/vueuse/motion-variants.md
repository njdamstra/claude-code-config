...
They are composed of any [Motion Properties](https://motion.vueuse.org/features/motion-properties) and an optional [Transition Properties](https://motion.vueuse.org/features/transition-properties).
...
It combines with , and is applied at the creation of the element.
...
You can use it to trigger an animation when the element appears, transitioning from [Initial](https://motion.vueuse.org/features/variants#initial-variant) variant.
...
In order to achieve a leave transition, you will have to access the [Motion Instance](https://motion.vueuse.org/features/motion-instance).
...
When the element leaves, the [Initial](https://motion.vueuse.org/features/variants#initial-variant) variant will be applied again.
