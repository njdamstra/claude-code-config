[Skip to content](https://appwrite.io/docs/products/auth/oauth2#main)
...
OAuth2 login creates an **identity** in Appwrite, allowing users to connect multiple providers to a single account. Learn more in [Identities](https://appwrite.io/docs/products/auth/identities).

## [Configure OAuth 2 login](https://appwrite.io/docs/products/auth/oauth2\#configure)
...
## [Initialize OAuth 2 login](https://appwrite.io/docs/products/auth/oauth2\#init)

To initialize the OAuth 2 login process, use the [Create OAuth 2 Session](https://appwrite.io/docs/references/cloud/client-web/account#createOAuth2Session) route.
...
JavascriptFlutterAppleAndroidReact Native

JavascriptFlutter
More

AppleAndroidReact Native
...
```web-code client-flutter line-numbers
...
```web-code client-apple line-numbers
...
```web-code client-android-kotlin line-numbers
...
```web-code client-react-native line-numbers
import { Client, Account, OAuthProvider } from "appwrite";
...
## [OAuth 2 profile](https://appwrite.io/docs/products/auth/oauth2\#profile)
...
An OAuth 2 [session](https://appwrite.io/docs/references/cloud/models/session) will have the following columns.
...
## [Refresh tokens](https://appwrite.io/docs/products/auth/oauth2\#refresh-tokens)
...
Check the value of `providerAccessTokenExpiry` to know if the token is expired or is about to expire. You can refresh the provider session by calling the [Update OAuth Session](https://appwrite.io/docs/references/cloud/client-web/account#updateSession) endpoint whenever your user visits your app. Avoid refreshing before every request, which might cause rate limit problems.
