...
The rest of the variants properties can be found on the [Variants](https://motion.vueuse.org/features/variants) page.
...
Otherwise, they will be applied on the `initial` [variant](https://motion.vueuse.org/features/variants) instead.
...
You can access motions controls using [useMotions](https://motion.vueuse.org/api/use-motions).
...
In the above example, the custom object will be an instance of [Motion Instance](https://motion.vueuse.org/features/motion-instance).
