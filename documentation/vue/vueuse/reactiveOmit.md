...
```ts
export type ReactiveOmit<
  T extends object,
  K extends keyof T | undefined = undefined,
> = [K] extends [undefined]
  ? UnwrapNestedRefs<T>
  : UnwrapNestedRefs<Omit<T, Exclude<keyof T, keyof K>>>
...
- [Source](https://github.com/vueuse/vueuse/blob/main/packages/shared/reactiveOmit/index.ts)
- [Docs](https://github.com/vueuse/vueuse/blob/main/packages/shared/reactiveOmit/index.md)
