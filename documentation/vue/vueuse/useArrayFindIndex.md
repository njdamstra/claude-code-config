...
```ts
import { useArrayFindIndex, ref } from '@vueuse/core'
...
- [Source Code](https://github.com/vueuse/vueuse/blob/main/packages/shared/useArrayFindIndex/index.ts)
- [Documentation](https://github.com/vueuse/vueuse/blob/main/packages/shared/useArrayFindIndex/index.md)
